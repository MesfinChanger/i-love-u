...
function MetricCard({ title, value, icon, href, color }: any) {
  return (
    <Link href={href}>
      <Card className="rounded-[2.5rem] border-none shadow-lg bg-white p-8 hover:shadow-2xl transition-all group overflow-hidden relative">
