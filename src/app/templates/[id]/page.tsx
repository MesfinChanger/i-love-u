      ...
      <main className="flex-grow pt-8 pb-20">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            {/* Left: Template Info & Customization */}
            <div className="lg:col-span-7 space-y-10">
              <section>
                ...
                <h1 className="text-4xl md:text-5xl font-black mb-6 font-headline">{template.name}</h1>
              ...
              <Tabs defaultValue={isCustomizing ? "customize" : "details"} className="w-full">
                <TabsList className="bg-neutral-100 p-1 w-full flex">
                  <TabsTrigger value="details" className="flex-1 py-3 text-sm gap-2">
                    <Info className="w-4 h-4" />
                    Project Details
                  </TabsTrigger>
                  <TabsTrigger value="customize" className="flex-1 py-3 text-sm gap-2">
                    <Settings2 className="w-4 h-4" />
                    Customize Configuration
                  </TabsTrigger>
                  <TabsTrigger value="ai" className="flex-1 py-3 text-sm gap-2">
                ...
                <TabsContent value="details" className="pt-8 space-y-8 animate-in fade-in duration-300">
                  ...
                  <div className="bg-white border rounded-2xl p-6">
                    <h3 className="font-bold mb-4">Initial Project Structure</h3>
                    <div className="bg-neutral-50 p-4 rounded-xl font-mono text-xs text-muted-foreground space-y-1">
                      <div>lib/</div>
                      <div className="ml-4">main.dart</div>
                      <div className="ml-4">core/</div>
                      <div className="ml-8">config/</div>
                      <div className="ml-8">constants/</div>
                ...
                <TabsContent value="customize" className="pt-8 space-y-8 animate-in fade-in duration-300">
                    ...
                    <div className="flex items-center gap-6 p-6 bg-white border rounded-2xl">
                       <div className="space-y-2 flex-1">
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            />
                            <code className="bg-neutral-100 px-3 py-1 rounded text-sm code-font">{primaryColor.toUpperCase()}</code>
                          </div>
                       </div>
                       <div className="w-px h-16 bg-neutral-100 hidden sm:block" />
                       <div className="flex-1 hidden sm:block">
                          <p className="text-sm text-muted-foreground">This color will be applied to your app's theme throughout the Flutter codebase.</p>
                       </div>
                    </div>
                  </div>
                  ...
                  <div className="pt-4">
                    ...
                    <p className="text-center text-xs text-muted-foreground mt-4">
                      Includes full source code, pubspec.yaml, and project assets.
                    </p>
                  </div>
                </TabsContent>
