 ...
 * Ensure NEXT_PUBLIC_FIREBASE_API_KEY is set in your Firebase App Hosting environment.
 */
...
if (!firebaseConfig.apiKey && typeof window !== 'undefined') {
  console.warn("Firebase API Key is missing. Set NEXT_PUBLIC_FIREBASE_API_KEY in environment variables.");
}
