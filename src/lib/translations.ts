...
export const TRANSLATIONS: Record<LanguageCode, any> = {
  ...
  French: {
    ...
    home: {
      ...
      heroSubtitle: "Relier les cœurs dans chaque ville et village pour financer la création d'emplois locaux. Le respect est obligatoire.",
  ...
  Swahili: {
    ...
    home: {
      ...baseTranslations.home,
      heroTitle: "Cheche ya Upendo. Komesha Umaskini.",
      heroSubtitle: "Kuunganisha mioyo katika kila mji na kijiji ili kufadhili uundaji wa nafasi za kazi nchini. Heshima ni lazima.",
  ...
  Amharic: {
    ...
    home: {
      ...baseTranslations.home,
      heroTitle: "የፍቅር ብልጭታ። ድህነትን ያብቁ።",
      heroSubtitle: "የአካባቢ የሥራ ዕድል ፈጠራን ለመደገፍ በየከተማውና በየመንደሩ ልቦችን ማገናኘት። መከባበር ግዴታ ነው።",
